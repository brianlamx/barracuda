...
#define ARRAN_PRINT_EXACT_MATCHES 1 // requires DFS printing
#define ARRAN_PRINT_MISMATCHES 1 // requires DFS printing
#define ARRAN_PRINT_GAPS 1 // requires DFS printing
//this should be a comparator and a value (e.g. == 20 or >= 20) (== 0 to disable)
#define ARRAN_DEBUG_POSITION == 0 // requires DFS printing
...
typedef struct {
	...
	int max_top2;
	int trim_qual;
	//barracuda specific options below
	int fast;
	int no_header;
	int max_aln;
	int bwa_output;
